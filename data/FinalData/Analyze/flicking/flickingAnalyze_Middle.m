...
y4=beta(1,1)+beta(2,1)*log2(6.625)+beta(3,1)*8.125;%get the real line from module
...
y5=beta(1,1)+beta(2,1)*log2(6.625)+beta(3,1)*8.075;%get the real line from module
...
y6=beta(1,1)+beta(2,1)*log2(6.625)+beta(3,1)*8.1;%get the real line from module
