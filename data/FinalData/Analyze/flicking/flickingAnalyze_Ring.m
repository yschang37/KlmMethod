...
y4=beta(1,1)+beta(2,1)*log2(6.625)+beta(3,1)*7.75;%get the real line from module
...
y5=beta(1,1)+beta(2,1)*log2(6.625)+beta(3,1)*7.375;%get the real line from module
...
y6=beta(1,1)+beta(2,1)*log2(6.625)+beta(3,1)*7.5625;%get the real line from module
